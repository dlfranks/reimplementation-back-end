begin
	...
	response_map2 = ResponseMap.find_or_create_by(reviewer_id:participant2.id) do |review_response_map|
      review_response_map.update!(
        reviewed_object_id:assignment1.id,
    ...
    response2 = Response.find_or_create_by(map_id:2) do |response|
      response.update!(
        map_id: response_map2.id,
        additional_comment: 'additional comment',
        round:1,
        version_num:1
      )
    end
    answer3 = Answer.find_or_create_by(answer:3) do |answer|
      answer.update!(
        answer:3,
        comments:'Answer1 text',
        question_id: question1.id,
    ...
    answer4 = Answer.find_or_create_by(answer:4) do |answer|
      answer.update!(
        answer:4,
        comments:'Answer2 text',
        question_id: question2.id,
